...
class MLP:
    def __init__(self, n_input, n_hidden, n_output, lr=0.1, beta=0.9):
        ...
        # momentum: one velocity per weight tensor, same shape, init to zeros
    ...
    def backward(self, X, y):
        ...
        # MOMENTUM UPDATE: accumulate velocity, then step using velocity
